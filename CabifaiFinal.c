...
void menuUsuario(){
	...
	printf("         ____________                          MENU DE USUARIO:                  \t        ____________\n");
	printf("        / ___   __  |                           --------------                   \t       / ___   __  | \n");
	printf("  _____/ /___| /__| |__                 1.Ver usuarios registrados.              \t _____/ /___| /__| |__ \n");
	printf(" |         -    -     |                                                          \t|         -    -     | \n");
	printf(" |____   ______   ____|                 2.Seleccionar rutas.                     \t|____   ______   ____| \n");
	printf("     |__|      |__|                                                              \t    |__|      |__| \n");
	printf("                                        3.Cerrar sesion y salir.\n\n"	);
